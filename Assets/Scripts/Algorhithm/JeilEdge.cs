...
public class JeilEdge : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        points.Add(connectedNodes[1].transform.position - this.transform.position); // This is dumb. I need to make 2 separate arrays because their type need to be different?
